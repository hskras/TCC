...
<div id="header">
	...
	<div id="menu">
		<ul>
			<li class="active"><a href="layoutCliente.php?inicio=true"> Página Inicial </a></li>
	...
	<div id="content">
		<div class="post">
			...
			<?php
			 ...
			 else @include ('inicioCliente.php'); 
	...
	<div id="sidebar">
		<ul>
			...
			<li>
				...
				<ul>
					<li><a href="layoutCliente.php?alterar=true">Alterar Cadastro</a></li>
